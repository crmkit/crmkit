...
// Upsert and reminders feature tests live in their topic files
// (handlers_contact_test.go, handlers_company_test.go, handlers_reminders_test.go);
// this file is scoped to authorization and escalation.
